...
- **Vector databases**: Local or remote databases (Weaviate, ChromaDB) for document indexing
- **AI models**: Integration with OpenAI and any OpenAI-compatible providers (Ollama, vLLM, etc.)
...
<Steps>
  ...
  <Step title="Models">
    Connect OpenAI or any OpenAI-compatible provider (Ollama, vLLM, etc.).
  </Step>
